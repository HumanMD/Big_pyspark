...
net, im, fm = pnml_importer.apply(gf.rootLocalPathPnml + gf.pnml[gf.test])
df = lr \
    .create_rdd_from_xes(spark, gf.rootHdfsPath + gf.xes[gf.test]) \
...
# CAUSAL RELATIONS (cr)
log = xes_importer.apply(gf.rootLocalPathXes + gf.xes[gf.test])
