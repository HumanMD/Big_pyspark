...
#     .set_log_path(rootHdfsPath + xes[test]) \
#     .set_pm_path(rootHdfsPath + pnml[test]) \
#     .set_log_slices(500) \
#     .set_pm_slices(1) \
...
# alignments_cr = []
# todo prova a trovare un alternativa a scrivere cr in ogni riga del df
# for trace in log:
...
#
# df_alignments_cr.printSchema()
# df_alignments_cr.show()
